        ...
        <AccordionPrimitive.Trigger {...props} asChild>
          <Trigger
            className={cn(
              ...
              Platform.select({
                web: 'focus-visible:border-ring focus-visible:ring-ring/50 flex flex-1 outline-none transition-all hover:underline focus-visible:ring-[3px] disabled:pointer-events-none',
              }),
              className
            )}>
            <>{children}</>
